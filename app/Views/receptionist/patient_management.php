                    ...
                    <table class="w-full min-w-[1100px] table-fixed">
                        ...
                        <thead class="bg-gray-50 sticky top-0 z-10 border-b border-gray-200">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">Username</th>
                        ...
                        <thead class="bg-gray-100 sticky top-[61px] z-10 border-b border-gray-300">
                            <tr>
                                ...
                                <th class="px-2 py-3">
                                    <input type="text" x-model="filters.username" @input="filterPatients" placeholder="Username..."
                                        class="w-full px-3 py-1.5 text-xs border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#06b6d4]">
                                </th>
                                <th class="px-2 py-3">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <template x-for="(patient, index) in paginatedPatients" :key="patient.id">
                                <tr @click="selectPatient(patient)"
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-600 whitespace-nowrap" x-text="patient.username"></td>
                ...
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" x-model="selectedPatient.username" disabled class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-xl">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Password</label>
                            <div class="relative">
                                <input type="password" value="••••••••" disabled class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-xl pr-12">
...
function patientManager() {
    return {
        patients: [
            { id: 'OP123456789', nationalId: 'OP123456789', name: 'Nguyen Van An', username: 'anpv1977', sex: 'Male', dob: '22/12/1977', phone: '0123456789', email: 'patient@example.com' },
            { id: 'OP123456790', nationalId: 'OP123456790', name: 'Tran Thi Be', username: 'betran1985', sex: 'Female', dob: '15/03/1985', phone: '0987654321', email: 'be.tran@gmail.com' },
            { id: 'OP123456791', nationalId: 'OP123456791', name: 'Le Van Cuong', username: 'cuonglv', sex: 'Male', dob: '10/08/1992', phone: '0909090909', email: 'cuong.le@outlook.com' },
            { id: 'OP123456792', nationalId: 'OP123456792', name: 'Pham Thi Dung', username: 'dungpham', sex: 'Female', dob: '05/11/1988', phone: '0912345678', email: 'dung.pham@yahoo.com' },
            { id: 'OP123456793', nationalId: 'OP123456793', name: 'Hoang Van Em', username: 'emhv1990', sex: 'Male', dob: '30/06/1990', phone: '0933333333', email: 'em.hoang@gmail.com' },
            { id: 'OP123456794', nationalId: 'OP123456789', name: 'Nguyen Van An', username: 'anpv1977', sex: 'Male', dob: '22/12/1977', phone: '0123456789', email: 'patient@example.com' },
            { id: 'OP123456795', nationalId: 'OP123456790', name: 'Tran Thi Be', username: 'betran1985', sex: 'Female', dob: '15/03/1985', phone: '0987654321', email: 'be.tran@gmail.com' },
            { id: 'OP123456796', nationalId: 'OP123456791', name: 'Le Van Cuong', username: 'cuonglv', sex: 'Male', dob: '10/08/1992', phone: '0909090909', email: 'cuong.le@outlook.com' },
            { id: 'OP123456797', nationalId: 'OP123456792', name: 'Pham Thi Dung', username: 'dungpham', sex: 'Female', dob: '05/11/1988', phone: '0912345678', email: 'dung.pham@yahoo.com' },
            { id: 'OP123456798', nationalId: 'OP123456793', name: 'Hoang Van Em', username: 'emhv1990', sex: 'Male', dob: '30/06/1990', phone: '0933333333', email: 'em.hoang@gmail.com' },
            { id: 'OP123456799', nationalId: 'OP123456789', name: 'Nguyen Van An', username: 'anpv1977', sex: 'Male', dob: '22/12/1977', phone: '0123456789', email: 'patient@example.com' },
            { id: 'OP123456800', nationalId: 'OP123456790', name: 'Tran Thi Be', username: 'betran1985', sex: 'Female', dob: '15/03/1985', phone: '0987654321', email: 'be.tran@gmail.com' },
            { id: 'OP123456801', nationalId: 'OP123456791', name: 'Le Van Cuong', username: 'cuonglv', sex: 'Male', dob: '10/08/1992', phone: '0909090909', email: 'cuong.le@outlook.com' },
            { id: 'OP123456802', nationalId: 'OP123456792', name: 'Pham Thi Dung', username: 'dungpham', sex: 'Female', dob: '05/11/1988', phone: '0912345678', email: 'dung.pham@yahoo.com' },
            { id: 'OP123456803', nationalId: 'OP123456793', name: 'Hoang Van Em', username: 'emhv1990', sex: 'Male', dob: '30/06/1990', phone: '0933333333', email: 'em.hoang@gmail.com' },
            { id: 'OP123456804', nationalId: 'OP123456789', name: 'Nguyen Van An', username: 'anpv1977', sex: 'Male', dob: '22/12/1977', phone: '0123456789', email: 'patient@example.com' },
            { id: 'OP123456805', nationalId: 'OP123456790', name: 'Tran Thi Be', username: 'betran1985', sex: 'Female', dob: '15/03/1985', phone: '0987654321', email: 'be.tran@gmail.com' },
            { id: 'OP123456806', nationalId: 'OP123456791', name: 'Le Van Cuong', username: 'cuonglv', sex: 'Male', dob: '10/08/1992', phone: '0909090909', email: 'cuong.le@outlook.com' },
            { id: 'OP123456807', nationalId: 'OP123456792', name: 'Pham Thi Dung', username: 'dungpham', sex: 'Female', dob: '05/11/1988', phone: '0912345678', email: 'dung.pham@yahoo.com' },
            { id: 'OP123456808', nationalId: 'OP123456793', name: 'Hoang Van Em', username: 'emhv1990', sex: 'Male', dob: '30/06/1990', phone: '0933333333', email: 'em.hoang@gmail.com' },
        ],
        filteredPatients: [],
        paginatedPatients: [],
        ...
        filterPatients() {
            this.filteredPatients = this.patients.filter(patient => {
                return (
                    ...
                    patient.username.toLowerCase().includes(this.filters.username.toLowerCase()) &&
